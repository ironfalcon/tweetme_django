...
class TweetTestCase(TestCase):
    def setUp(self):
        ...
        self.userb = User.objects.create_user(username='test-2', password='somepassword2')
    ...
    def test_tweet_delete_api_view(self):
        ...
        respons_incorrect_owner = client.delete("/api/tweets/3/delete/")
        self.assertEqual(respons_incorrect_owner.status_code, 401)